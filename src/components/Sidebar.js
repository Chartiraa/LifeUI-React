...
import { faExclamationTriangle, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faSignOutAlt, faTimes } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="CSA Robotics - Life UI" link={Routes.DashboardOverview} image={ReactHero} />

              <NavItem title="Control Panel" link={Routes.DashboardOverview.path} icon={faChartPie} />
              <NavItem title="Log Page" icon={faHandHoldingUsd} link={Routes.Transactions.path} />
